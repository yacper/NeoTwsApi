...
public class Sample
{
    ...
    public static int Main(string[] args)
    {
        ...
        clientSocket.eConnect("127.0.0.1", 4002, 0);  // gateway
        //! [connect]
        //! [ereader]
    ...
    private static void wshCalendarOperations(EClientSocket client)
    {
        ...
        client.reqWshEventData(1102,
            new WshEventData("{\"watchlist\":[\"8314\"]}", false, false, false, "", "20220512", int.MaxValue));
        //! [reqeventdata]
    ...
    {
        //! [reqhistoricalticks]
        client.reqHistoricalTicks(18001, ContractSamples.USStockAtSmart(), "20170712 21:39:33", null, 10, "TRADES", 1,
            true, null);
        client.reqHistoricalTicks(18002, ContractSamples.USStockAtSmart(), "20170712 21:39:33", null, 10, "BID_ASK", 1,
            true, null);
        client.reqHistoricalTicks(18003, ContractSamples.USStockAtSmart(), "20170712 21:39:33", null, 10, "MIDPOINT", 1,
            true, null);
        //! [reqhistoricalticks]
    }
    ...
    private static void smartComponents(EClientSocket client)
    {
        ...
        while (string.IsNullOrWhiteSpace(testImpl.BboExchange)) { Thread.Sleep(1000); }
    ...
    private static void historicalDataRequests(EClientSocket client)
    {
        ...
        client.reqHistoricalData(4001, ContractSamples.EurGbpFx(), queryTime, "1 M", "1 day", "MIDPOINT", 1, 1, false,
            null);
        client.reqHistoricalData(4002, ContractSamples.EuropeanStock(), queryTime, "10 D", "1 min", "TRADES", 1, 1,
            false, null);
        client.reqHistoricalData(4003, ContractSamples.USStockAtSmart(), queryTime, "1 M", "1 day", "SCHEDULE", 1, 1,
            false, null);
        //! [reqhistoricaldata]
        Thread.Sleep(10000);
    ...
    private static void orderOperations(EClientSocket client, int nextOrderId)
    {
        ...
        ***/
        ...
        client.placeOrder(nextOrderId++, ContractSamples.IBKRATSContract(),
            OrderSamples.PegBestUpToMidOrder("BUY", Util.StringToDecimal("100"), 111.11, 100, 200, 0.02, 0.025));
        //! [pegbest_up_to_mid_order_submission]
    ...
    private static void continuousFuturesOperations(EClientSocket client)
    {
        ...
        client.reqHistoricalData(18002, ContractSamples.ContFut(), queryTime, "1 Y", "1 month", "TRADES", 0, 1, false,
            null);
        Thread.Sleep(10000);
    ...
    private static void reqContractDetails(EClientSocket client, int nextOrderId)
    {
        Contract optionContract = ContractSamples.EurGbpFx();

        client.reqContractDetails(nextOrderId, optionContract);
    }
}
