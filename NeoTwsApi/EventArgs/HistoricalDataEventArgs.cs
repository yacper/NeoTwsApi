...
namespace AutoFinance.Broker.InteractiveBrokers.EventArgs
{
    ...
    public class HistoricalDataEventArgs
    {
        ...
        public HistoricalDataEventArgs(int requestId, string date, double open, double high, double low, double close, int volume, int count, decimal wap, bool hasGaps)
        {
