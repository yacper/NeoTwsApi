...
//        public event EventHandler<HistoricalDataEndEventArgs> HistoricalDataEndEvent;
    ...
    /// <inheritdoc/>
    public void accountSummaryEnd(int reqId) { this.AccountSummaryEndEvent?.Invoke(this, new RequestEndEventArgs(reqId)); }
    ...
    /// <inheritdoc/>
    public void accountUpdateMultiEnd(int requestId) { this.AccountUpdateMultiEndEvent?.Invoke(this, new RequestEndEventArgs(requestId)); }
    ...
    /// <inheritdoc/>
    public void commissionReport(CommissionReport commissionReport) { this.CommissionReportEvent?.Invoke(this, new CommissionReportEventArgs(commissionReport)); }
    ...
    /// <inheritdoc/>
    public void completedOrdersEnd() { this.CompletedOrdersEndEvent?.Invoke(this, System.EventArgs.Empty); }

    /// <inheritdoc/>
    public void connectAck() { this.ConnectionAcknowledgementEvent?.Invoke(this, System.EventArgs.Empty); }

    /// <inheritdoc/>
    public void connectionClosed() { this.ConnectionClosedEvent?.Invoke(this, System.EventArgs.Empty); }
    ...
    /// <inheritdoc/>
    public void deltaNeutralValidation(int reqId, DeltaNeutralContract deltaNeutralContract) { throw new NotImplementedException(); }
    ...
    public void historicalData(int reqId, Bar bar) { this.HistoricalDataEvent?.Invoke(this, new TwsEventArs<Bar>(reqId, bar)); }
    ...
    /// <inheritdoc/>
    public void positionMultiEnd(int requestId) { this.RequestPositionsMultiEndEvent?.Invoke(this, new RequestEndEventArgs(requestId)); }
    ...
    /// <inheritdoc/>
    public void symbolSamples(int reqId, ContractDescription[] contractDescriptions) { SymbolSamplesEvent?.Invoke(this, new TwsEventArs<ContractDescription[]>(reqId, contractDescriptions)); }
    ...
    /// <inheritdoc/>
    public void tickOptionComputation(int    tickerId, int    field, int    tickAttrib, double impliedVolatility, double delta, double optPrice, double pvDividend,
    ...
    /// <inheritdoc/>
    public void tickPrice(int tickerId, int field, double price, int canAutoExecute) { throw new NotImplementedException(); }
    ...
    /// <inheritdoc/>
    public void updateMktDepth(int tickerId, int position, int operation, int side, double price, decimal size) { throw new NotImplementedException(); }

    /// <inheritdoc/>
    public void updateMktDepthL2(int tickerId, int position, string marketMaker, int operation, int side, double price, decimal size) { throw new NotImplementedException(); }
    ...
    /// <inheritdoc/>
    public void updatePortfolio(Contract contract, decimal position, double marketPrice, double marketValue, double averageCost, double unrealisedPNL, double realisedPNL,
                                string   accountName)
    {
    ...
    public void wshMetaData(int reqId, string dataJson) { throw new NotImplementedException(); }
    ...
    /**
         ...
         */
    public void wshEventData(int reqId, string dataJson) { throw new NotImplementedException(); }

    public void historicalSchedule(int reqId, string startDateTime, string endDateTime, string timeZone, HistoricalSession[] sessions) { throw new NotImplementedException(); }
    ...
    /**
         ...
         */
    public void userInfo(int reqId, string whiteBrandingId) { throw new NotImplementedException(); }
}